...
> **new HttpVersionNotSupported**(`msgOrParams`?): [`HttpVersionNotSupported`](HttpVersionNotSupported.md)
...
[`HttpVersionNotSupported`](HttpVersionNotSupported.md)
...
> `static` `readonly` **STATUS**: `505` = `status`
