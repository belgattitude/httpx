...
[@httpx/exception](../../README.md) / [server](../README.md) / HttpGatewayTimeout
...
> **new HttpGatewayTimeout**(`msgOrParams`?): [`HttpGatewayTimeout`](HttpGatewayTimeout.md)
...
> `readonly` `static` **STATUS**: `504` = `status`
