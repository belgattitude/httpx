...
[@httpx/exception](../../README.md) / [server](../README.md) / HttpInternalServerError
...
> **new HttpInternalServerError**(`msgOrParams`?): [`HttpInternalServerError`](HttpInternalServerError.md)
...
> `static` `readonly` **STATUS**: `500` = `status`
