...
> **new HttpInsufficientStorage**(`msgOrParams`?): [`HttpInsufficientStorage`](HttpInsufficientStorage.md)
...
[`HttpInsufficientStorage`](HttpInsufficientStorage.md)
...
> `static` `readonly` **STATUS**: `507` = `status`
