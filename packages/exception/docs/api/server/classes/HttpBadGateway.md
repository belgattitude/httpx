...
[@httpx/exception](../../README.md) / [server](../README.md) / HttpBadGateway
...
> **new HttpBadGateway**(`msgOrParams`?): [`HttpBadGateway`](HttpBadGateway.md)
...
> `readonly` `static` **STATUS**: `502` = `status`
