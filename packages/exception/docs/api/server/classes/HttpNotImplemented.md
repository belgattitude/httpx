...
[@httpx/exception](../../README.md) / [server](../README.md) / HttpNotImplemented
...
> **new HttpNotImplemented**(`msgOrParams`?): [`HttpNotImplemented`](HttpNotImplemented.md)
...
> `readonly` `static` **STATUS**: `501` = `status`
