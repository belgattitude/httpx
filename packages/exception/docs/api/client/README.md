...
[@httpx/exception](../README.md) / client
...
- [HttpFailedDependency](classes/HttpFailedDependency.md)
...
- [HttpLocked](classes/HttpLocked.md)
...
- [HttpProxyAuthenticationRequired](classes/HttpProxyAuthenticationRequired.md)
...
- [HttpTooEarly](classes/HttpTooEarly.md)
