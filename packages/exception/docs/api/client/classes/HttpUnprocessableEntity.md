...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpUnprocessableEntity
...
> `readonly` **issues**: [`HttpValidationIssue`](../../types/type-aliases/HttpValidationIssue.md)[]
...
> `readonly` `static` **STATUS**: `422` = `status`
