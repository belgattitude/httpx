...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpBadRequest
...
> **new HttpBadRequest**(`msgOrParams`?): [`HttpBadRequest`](HttpBadRequest.md)
...
> `readonly` `static` **STATUS**: `400` = `status`
