...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpMethodNotAllowed
...
> **new HttpMethodNotAllowed**(`msgOrParams`?): [`HttpMethodNotAllowed`](HttpMethodNotAllowed.md)
...
> `readonly` `static` **STATUS**: `405` = `status`
