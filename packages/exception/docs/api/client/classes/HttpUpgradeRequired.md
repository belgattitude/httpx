...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpUpgradeRequired
...
### new HttpUpgradeRequired()

> **new HttpUpgradeRequired**(`msgOrParams`?): [`HttpUpgradeRequired`](HttpUpgradeRequired.md)
...
> `readonly` `static` **STATUS**: `426` = `status`
