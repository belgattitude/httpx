...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpTooEarly
...
> **new HttpTooEarly**(`msgOrParams`?): [`HttpTooEarly`](HttpTooEarly.md)
...
> `readonly` `static` **STATUS**: `425` = `status`
