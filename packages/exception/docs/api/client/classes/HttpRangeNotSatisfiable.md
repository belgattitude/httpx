...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpRangeNotSatisfiable
...
### new HttpRangeNotSatisfiable()

> **new HttpRangeNotSatisfiable**(`msgOrParams`?): [`HttpRangeNotSatisfiable`](HttpRangeNotSatisfiable.md)
...
> `readonly` `static` **STATUS**: `416` = `status`
