...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpLengthRequired
...
> **new HttpLengthRequired**(`msgOrParams`?): [`HttpLengthRequired`](HttpLengthRequired.md)
...
> `readonly` `static` **STATUS**: `411` = `status`
