...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpNotAcceptable
...
> **new HttpNotAcceptable**(`msgOrParams`?): [`HttpNotAcceptable`](HttpNotAcceptable.md)
...
> `readonly` `static` **STATUS**: `406` = `status`
