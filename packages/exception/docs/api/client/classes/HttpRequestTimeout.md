...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpRequestTimeout
...
> **new HttpRequestTimeout**(`msgOrParams`?): [`HttpRequestTimeout`](HttpRequestTimeout.md)
...
> `readonly` `static` **STATUS**: `408` = `status`
