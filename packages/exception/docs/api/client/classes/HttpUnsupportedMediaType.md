...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpUnsupportedMediaType
...
> **new HttpUnsupportedMediaType**(`msgOrParams`?): [`HttpUnsupportedMediaType`](HttpUnsupportedMediaType.md)
...
> `static` `readonly` **STATUS**: `415` = `415`
