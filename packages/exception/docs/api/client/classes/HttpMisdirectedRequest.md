...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpMisdirectedRequest
...
### new HttpMisdirectedRequest()

> **new HttpMisdirectedRequest**(`msgOrParams`?): [`HttpMisdirectedRequest`](HttpMisdirectedRequest.md)
...
> `readonly` `static` **STATUS**: `421` = `status`
