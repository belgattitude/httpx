...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpUnavailableForLegalReasons
...
> **new HttpUnavailableForLegalReasons**(`msgOrParams`?): [`HttpUnavailableForLegalReasons`](HttpUnavailableForLegalReasons.md)
...
> `readonly` `static` **STATUS**: `451` = `status`
