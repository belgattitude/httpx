...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpTooManyRequests
...
### new HttpTooManyRequests()

> **new HttpTooManyRequests**(`msgOrParams`?): [`HttpTooManyRequests`](HttpTooManyRequests.md)
...
> `readonly` `static` **STATUS**: `429` = `status`
