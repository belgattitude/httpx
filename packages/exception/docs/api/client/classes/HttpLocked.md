...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpLocked
...
> **new HttpLocked**(`msgOrParams`?): [`HttpLocked`](HttpLocked.md)
...
> `readonly` `static` **STATUS**: `423` = `status`
