...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpProxyAuthenticationRequired
...
> **new HttpProxyAuthenticationRequired**(`msgOrParams`?): [`HttpProxyAuthenticationRequired`](HttpProxyAuthenticationRequired.md)
...
[`HttpProxyAuthenticationRequired`](HttpProxyAuthenticationRequired.md)
...
> `readonly` `static` **STATUS**: `407` = `status`
