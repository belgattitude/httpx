...
### new HttpRequestHeaderFieldsTooLarge()

> **new HttpRequestHeaderFieldsTooLarge**(`msgOrParams`?): [`HttpRequestHeaderFieldsTooLarge`](HttpRequestHeaderFieldsTooLarge.md)
...
> `static` `readonly` **STATUS**: `431` = `status`
