...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpExpectationFailed
...
> **new HttpExpectationFailed**(`msgOrParams`?): [`HttpExpectationFailed`](HttpExpectationFailed.md)
...
> `readonly` `static` **STATUS**: `417` = `status`
