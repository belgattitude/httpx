...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpPayloadTooLarge
...
### new HttpPayloadTooLarge()

> **new HttpPayloadTooLarge**(`msgOrParams`?): [`HttpPayloadTooLarge`](HttpPayloadTooLarge.md)
...
> `readonly` `static` **STATUS**: `413` = `status`
