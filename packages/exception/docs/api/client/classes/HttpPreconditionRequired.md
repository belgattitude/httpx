...
[@httpx/exception](../../README.md) / [client](../README.md) / HttpPreconditionRequired
...
### new HttpPreconditionRequired()

> **new HttpPreconditionRequired**(`msgOrParams`?): [`HttpPreconditionRequired`](HttpPreconditionRequired.md)
...
> `readonly` `static` **STATUS**: `428` = `status`
